...
int main(int argc, char ** argv) {
    cmdline::parser pars;
    pars.add<int>("scale", 's', "number of records to insert", true);
    pars.add<int>("tree", 't', "the tree type", false, 1, cmdline::range(1, 4));
    ...
    std::uniform_int_distribution<_key_t> dist(0, INT64_MAX);
